...
const CreateTaskBottomSheet = ({ isOpen, onClose, onSubmit }: CreateTaskBottomSheetProps) => {
  ...
  return (
    <Dialog open={isOpen} onClose={handleClose} className="relative z-50 md:hidden">
        ...
        <DialogPanel className="bg-bg-light rounded-t-2xl max-h-[85vh] overflow-y-auto transform transition-transform duration-300 ease-out data-[closed]:translate-y-full">
          ...
          <div className="sticky top-0 bg-bg-light border-b border-border-muted px-6 py-4 rounded-t-2xl">
            <div className="flex items-center justify-between">
              <DialogTitle className="font-bold text-lg text-text">Nueva Tarea</DialogTitle>
              <button
                onClick={handleClose}
